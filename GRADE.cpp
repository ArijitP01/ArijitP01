...
int main(int argc, char* argv[])
{
 // Get starting timepoint
    ...
    *///-------------------------------------------------------------------------------------
    ...
    auto start_filein =chrono::high_resolution_clock::now(); 
    ...
    { 
        ...
        auto start_whilein =chrono::high_resolution_clock::now();
        ...
        auto stop_whilein =chrono::high_resolution_clock::now();
     auto duration_whilein = chrono::duration_cast<chrono::microseconds>(stop_whilein - start_whilein);
 
    cout << "Total Time taken by File in while loop: "
         << duration_whilein.count() << " microseconds" << endl;

        auto start_whilein_second =chrono::high_resolution_clock::now();     
            while (atom_Pos.size() <= Natoms && atom_Pos.size() > 9999)
            {
        ...
        auto stop_whilein_second =chrono::high_resolution_clock::now();
     auto duration_whilein_second = chrono::duration_cast<chrono::microseconds>(stop_whilein_second - start_whilein_second);
 
    cout << "Total Time taken by File in while_second loop: "
         << duration_whilein_second.count() << " microseconds" << endl;
        ...
        auto stop_calc =chrono::high_resolution_clock::now();
        auto duration_calc = chrono::duration_cast<chrono::microseconds>(stop_calc - start_calc);
 
        cout << "Time taken by File in first_calc loop: "<< duration_calc.count() << " microseconds" << endl;
        ...
        auto start_ring_finder =chrono::high_resolution_clock::now();    
        ...
        auto stop_ring_finder =chrono::high_resolution_clock::now();
        auto duration_ring_finder = chrono::duration_cast<chrono::microseconds>(stop_ring_finder - start_ring_finder);
 
        cout << "Time taken by File in ring_finder loop: "<< duration_ring_finder.count() << " microseconds" << endl;


        auto start_calc_second =chrono::high_resolution_clock::now();     
        ...
        auto stop_calc_second=chrono::high_resolution_clock::now();
     auto duration_calc_second = chrono::duration_cast<chrono::microseconds>(stop_calc_second - start_calc_second);
 
    cout << "Time taken by File in second_calc loop: "
         << duration_calc_second.count() << " microseconds" << endl;    
            
            
        }
    }   //End of reading the input file.
    auto stop_filein =chrono::high_resolution_clock::now();
     auto duration_filein = chrono::duration_cast<chrono::microseconds>(stop_filein - start_filein);
 
    cout << "Total Time taken by File in loop: "
         << duration_filein.count() << " microseconds" << endl;
    ...
    cout << "Time taken by Main function: "
